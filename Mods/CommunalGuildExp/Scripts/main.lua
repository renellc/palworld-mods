...
local function init()
    ...
    local function get_players()
        ...
        local i = 1
        for _, player in pairs(all_player_list or {}) do
    ...
    local online_players = get_players()
    ...
    local known_players = {}
    local num_players = 0
    local function load_known_players()
    ...
    -- Serialize and save the party table
    local function save_known_players()
    ...
    local function level_up()
        ...
        local cur_lv = 0
        for _, player in pairs(online_players or {}) do
    ...
    RegisterHook("/Script/Pal.PalTechnologyData:OnUpdateLocalPlayerLevel", function()
        print("Level UP!")
        online_players = get_players()
        local cur_lv = 0
        for _, player in pairs(online_players or {}) do
...
pal_helpers.SafeInitialize(init, 'server')
