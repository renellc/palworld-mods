...
---@class UWBP_BossDemoDesert_C : UWBP_BossDemoBase_C
---@field UberGraphFrame FPointerToUberGraphFrame
---@field Image_395 UImage
---@field WBP_BossBattle_BossCut02 UWBP_BossBattle_BossCut02_C
...
function UWBP_BossDemoDesert_C:AnmEvent_Open() end
---@param EntryPoint int32
function UWBP_BossDemoDesert_C:ExecuteUbergraph_WBP_BossDemoDesert(EntryPoint) end
