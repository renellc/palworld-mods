...
UWBP_Key_Settings_C['On UI Action Key Changed'] = function(ActionName, NewKey, InputType, AxisType) end
---@param KeyName FName
---@param InputType ECommonInputType
---@param AxisType EPalKeyConfigAxisFilterType
UWBP_Key_Settings_C['On UI Key Config Changing'] = function(KeyName, InputType, AxisType) end
---@param TargetMap TMap<FName, FPalKeyConfigKeys>
---@param ActionName FName
---@param Key FPalKeyConfigKeys
UWBP_Key_Settings_C['Multi Key Setting'] = function(TargetMap, ActionName, Key) end
---@param FilterType EPalKeyConfigCategory
...
UWBP_Key_Settings_C['Get UI Conflict Actions'] = function(CheckingAction, FilterType, KeyActions) end
---@param ActionName FName
---@param NewKey FKey
---@param InputType EPalKeyConfigCategory
---@param AxisType EPalKeyConfigAxisFilterType
